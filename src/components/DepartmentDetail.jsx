      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="projects" className="space-y-4">
          ...
          <div className="space-y-4">
            {(Array.isArray(department.projects) ? department.projects.length : 0) === 0 ? (
              <div className="text-center p-4">
                <p className="text-muted-foreground">Chưa có dự án</p>
              </div>
            ) : (
              (Array.isArray(department.projects) ? department.projects : []).map((project) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {project?.assignedGroups?.length > 0 ? (
